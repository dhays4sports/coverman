...
(async () => {
  ...
  check('release version advanced to 3.19.24', ['3.19.24','3.19.25','3.19.26','3.19.27','3.19.28','3.19.29','3.19.31','3.20.0','3.20.1','3.20.2','3.20.4','3.20.5','3.20.6','3.20.7'].includes(version));
  ...
  check('server record version advanced', ['1.3.0','1.4.0','1.5.0'].includes(core.RECORD_VERSION));
  ...
  check('browser clients advanced to version 1.3.0', ['1.3.0','1.4.0'].includes(records.VERSION) && ['1.3.0','1.4.0'].includes(remote.VERSION));
