...
check('dashboard preparation message is present', html.includes('Preparing your Home Protection Dashboard'));
...
function createNode({ label = false, final = false } = {}) {
  ...
  const finalMessageNode = { textContent: 'Preparing your Home Protection Dashboard' };
  return {
    dataset: {},
    attributes: {},
    textContent: '',
...
check('final dashboard message activates at 1440ms', ready.elements.transitionFinal.dataset.state === 'active');
check('final dashboard message is announced', ready.elements.transitionStatus.textContent === 'Almost ready. Preparing your Home Protection Dashboard.');
