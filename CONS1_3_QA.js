...
(async () => {
  ...
  check('release version remains compatible after CONS-1.3', ['3.19.23','3.19.24','3.19.25','3.19.26','3.19.27','3.19.28','3.19.29','3.19.31','3.20.0','3.20.1','3.20.2','3.20.4','3.20.5','3.20.6','3.20.7'].includes(version));
  ...
  check('remote client exposes stable API', ['1.2.0','1.3.0','1.4.0'].includes(remote.VERSION) && typeof remote.submit === 'function' && typeof remote.sync === 'function');
