...
check('release version remains compatible after CONS-2.0', ['3.19.28','3.19.29','3.19.31','3.20.0','3.20.1','3.20.2','3.20.4','3.20.5','3.20.6','3.20.7'].includes(version));
...
check('trend uses the remote delivered timestamp before local created time', seven.buckets.some(bucket => bucket.label.includes('Aug 1') && bucket.consultations === 1));
...
check('CSV filename is deterministic and contains no customer PII', csv.filename === 'coveragefit-consultation-pipeline_2026-07-27_to_2026-08-02_exported-2026-08-02.csv' && !csv.filename.includes('dylan'));
