...
const partial=section.render({propertySummary:{available:true,address:'1 Test St'}}); assert.ok(partial.html.includes('Not available'));
console.log(JSON.stringify({suite:'P1.2.2 Property Summary Renderer',passed:11,failed:0},null,2));
