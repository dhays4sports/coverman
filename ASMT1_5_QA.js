...
(async () => {
  check('release version remains compatible after ASMT-1.5', ['3.20.5','3.20.6','3.20.7'].includes(version));
  ...
  check('answer feedback displays evidence quality without adding a question', engine.includes('renderAnswerFeedback') && engine.includes('Evidence quality'));
