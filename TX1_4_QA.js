...
check('controller version remains compatible at 1.4', source.includes("const VERSION = '1.4'"));
...
check('homebuyer supporting copy is tailored', homebuyer.elements.transitionMessage.textContent.includes('before you compare options for your new home'));
...
check('homebuyer final message is tailored', homebuyer.elements.transitionFinalMessage.textContent === 'Preparing your New Home Protection Dashboard');
...
check('renewal final message is tailored', renewal.elements.transitionFinalMessage.textContent === 'Preparing your Annual Protection Dashboard');
...
check('non-renewal supporting copy is tailored', nonRenewal.elements.transitionMessage.textContent.includes('next coverage options'));
...
check('non-renewal final message is tailored', nonRenewal.elements.transitionFinalMessage.textContent === 'Preparing your Coverage Review Dashboard');
...
check('premium-increase final message is tailored', premium.elements.transitionFinalMessage.textContent === 'Preparing your Protection Review Dashboard');
premium.runDelay(1440);
check('personalized final message is announced accessibly', premium.elements.transitionStatus.textContent === 'Almost ready. Preparing your Protection Review Dashboard.');
...
check('general heading remains intact', occupational.elements.transitionHeading.textContent === 'Preparing your CoverageFit experience');
...
check('fallback heading remains neutral', fallback.elements.transitionHeading.textContent === 'Preparing your CoverageFit experience');
