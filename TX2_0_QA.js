...
check('dashboard exposes a labeled Home Protection Dashboard heading', homeHtml.includes('aria-labelledby="homeDashboardTitle"') && homeHtml.includes('Home Protection Dashboard'));
...
check('dashboard heading acknowledges the prospect by first name', full.elements.homeDashboardTitle.textContent === 'Dylan, your Home Protection Dashboard is ready.');
