...
(async () => {
  ...
  check('release version remains compatible after CONS-1.7', ['3.19.25','3.19.26','3.19.27','3.19.28','3.19.29','3.19.31','3.20.0','3.20.1','3.20.2','3.20.4','3.20.5','3.20.6','3.20.7'].includes(version));
  ...
  check('server record version advanced', ['1.4.0','1.5.0'].includes(core.RECORD_VERSION));
  ...
  check('browser clients advanced to version 1.4.0', records.VERSION === '1.4.0' && remote.VERSION === '1.4.0');
