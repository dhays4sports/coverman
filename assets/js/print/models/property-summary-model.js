(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    ...
    root.CoverageFitPropertySummaryModel = factory();
  }
  ...
  function riskHighlights(property) {
    ...
    if (property.pool === true || String(property.pool).toLowerCase() === 'yes') values.push('Swimming pool exposure should be reviewed.');
    if (property.detachedStructures === true || String(property.detachedStructures).toLowerCase() === 'yes') values.push('Detached structures should be included in the coverage review.');
    if (property.roof) values.push(`Roof information: ${property.roof}.`);
